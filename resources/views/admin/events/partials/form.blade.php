...
<div class="form-group">
    ...
    {!! Form::radio('estado', 1, true )!!} <br>
    {!! Form::label('estado', 'Publicado') !!}
    {!! Form::radio('estado', 2) !!} <br>       
    {!! Form::label('estado', 'Finalizado') !!}
    {!! Form::radio('estado', 3) !!}
</div>
...
<div class="form-group">
    ...
    {{-- {!! Form::select('users[]', $users->pluck('name', 'id'),null, ['class' => 'form-control selectpicker', 'placeholder' => '--- Seleccione expositores ---', 'multiple' => 'multiple']) !!} --}}

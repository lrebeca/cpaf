...
<div>
    ...
    <a href="{{route('admin.events.enviadospdf', $event)}}" class="btn btn-info btn-outline-dark">Descargar lista</a> <br><br>
    ...
    <div class="car-body">
        <table id="participantes" class="table dt-responsive table-striped nowrap">
            <thead class="table-dark">
                ...
                <th>Estado</th>
                @can('Aprobar Participante')
                <th></th>
                @endcan
                @can('Rechazar Participante')
                <th></th>
                @endcan
                @can('Editar Participantes Pendientes')
                <th>Editar</th>
                @endcan
                @can('Eliminar Participantes Pendientes')
                <th>Eliminar</th>
                @endcan
            </thead>
            <tbody>

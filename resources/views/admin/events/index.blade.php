...
@endcan
    ...
    <div class="card">
        <div class="card-body">
            <table id="eventos" class="table table-striped dt-responsive nowrap">
                    ...
                    @foreach ($events as $event)
                        @foreach ($users as $user)
                            ...
                            @foreach ($provinces as $province)
                                @if ($event->user_id == $user->id && $event->id_organizador == $organizer->id && $event->province_id == $province->id)
                                <tr>
                                    <td>&nbsp;&nbsp;{{$event->id}}</td>
                                    <td>{{$event->evento}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <textarea cols="40" rows="1" disabled="disabled" placeholder="">{!!strip_tags($event->detalle)!!}
                                        </textarea>
                                    </td>
                                    ...
                                    <td>
                                        @foreach ($certificates as $certificate)
                                            @if ($certificate->id_evento == $event->id)
                                                <a href="{{route('admin.events.certificado', $event)}}" class="btn btn-outline-dark">Certificado</a>
                                            @else
